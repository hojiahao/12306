...
public enum BusinessExceptionEnum {
    ...
    BUSINESS_TRAIN_STATION_INDEX_UNIQUE_ERROR("Station number of the same train already exists"),
    BUSINESS_TRAIN_STATION_NAME_UNIQUE_ERROR("Station name of the same train already exists"),
    BUSINESS_TRAIN_CARRIAGE_INDEX_UNIQUE_ERROR("Car number of the same train already exists");
