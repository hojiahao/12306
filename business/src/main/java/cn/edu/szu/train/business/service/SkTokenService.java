...
import cn.edu.szu.train.business.mapper.custom.CustomizedSkTokenMapper;
...
public class SkTokenService {
    ...
    @Resource
    private CustomizedSkTokenMapper customizedSkTokenMapper;
    ...
    public boolean validSkToken(Date date, String trainCode, Long memberId) {
        ...
        if (skTokenCount != null) {
            ...
            if (count < 0L) {
                ...
                // 每获取5个令牌更新一次数据库
                if (count % 5 == 0) {
                    customizedSkTokenMapper.decrease(date, trainCode, 5);
                }
                return true;
            }
        } else {
