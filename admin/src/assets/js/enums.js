...
SEAT_TYPE={FIRSTCLASS:{code:"1",desc:"一等座",price:"0.4"},SECONDCLASS:{code:"2",desc:"二等座",price:"0.3"},SOFTSLEEPER:{code:"3",desc:"软卧",price:"0.6"},HARDSLEEPER:{code:"4",desc:"硬卧",price:"0.5"}};
SEAT_COL={FIRSTCLASS_A:{code:"A",desc:"A",type:"1"},FIRSTCLASS_C:{code:"C",desc:"C",type:"1"},FIRSTCLASS_D:{code:"D",desc:"D",type:"1"},FIRSTCLASS_F:{code:"F",desc:"F",type:"1"},SECONDCLASS_A:{code:"A",desc:"A",type:"2"},SECONDCLASS_B:{code:"B",desc:"B",type:"2"},SECONDCLASS_C:{code:"C",desc:"C",type:"2"},SECONDCLASS_D:{code:"D",desc:"D",type:"2"},SECONDCLASS_F:{code:"F",desc:"F",type:"2"}};
